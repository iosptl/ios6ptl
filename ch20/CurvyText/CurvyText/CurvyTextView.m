...
static const CGFloat kControlPointSize = 23.;
...
- (void)addControlPoint:(CGPoint)point color:(UIColor *)color {
  CGRect rect = CGRectMake(kControlPointSize/2, kControlPointSize/2, kControlPointSize, kControlPointSize);
  ...
  UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kControlPointSize*2, kControlPointSize*2)];
...
- (void)prepareContext:(CGContextRef)context forRun:(CTRunRef)run {
  ...
  // Set color
  UIColor *color = (UIColor *)CFDictionaryGetValue(attributes,
